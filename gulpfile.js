...
var basePaths = {
    ...
    dev:    'src/',
    dist:   'dist/html/system/user/templates/default_site/',
    assets: 'dist/html/themes/user/site/default/assets/'
...
gulp.task('watch', function() {
    ...
    browsersync.init({
        ...
        proxy: "http://labyrinthlogistics.local",
        host: "labyrinthlogistics.local",
        open: "external"
